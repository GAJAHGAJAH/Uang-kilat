...
import '../../presentation/pages/auth/biometric_lock_page.dart';
...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
        ...
        routes: [
          ...
          GoRoute(
            path: '/biometric-lock',
            builder: (_, __) => const BiometricLockPage(),
          ),
          GoRoute(
            path: '/register',
          ...
          // Pembayaran via deeplink merchant (uangkilat://pay?... atau https://uangkilat.app/pay?...)
          GoRoute(
            path: '/pay',
